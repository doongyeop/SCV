...
public interface GithubApiService {
    ...
    /**
     * <p>GitHub 에서 블록 파일을 import 하는 메서드</p>
     ...
     */
    Optional<GithubRepoBlockFileApiResponseDTO> importGithubRepoBlockFile(CustomOAuth2User authUser, DataSet dataName, String modelName);

    /**
     * <p>GitHub 에 블록 파일을 export 하는 메서드</p>
     ...
     */
    void exportGithubRepoBlockFile(CustomOAuth2User authUser, DataSet dataName, String modelName, ExportGithubRepoBlockFileApiRequestDTO requestDTO);
