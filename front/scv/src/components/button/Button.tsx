...
const Button: React.FC<ButtonProps> = ({
  ...
  const sizeClasses = {
    l: "inline-flex shrink-0 whitespace-nowrap justify-center items-center h-56 p-16 text-17 gap-8 rounded-12",
    m: "inline-flex shrink-0 whitespace-nowrap justify-center items-center h-48 p-16 text-16 gap-8 rounded-10",
    s: "inline-flex shrink-0 whitespace-nowrap justify-center items-center h-40 p-16 text-15 gap-8 rounded-8",
  };
