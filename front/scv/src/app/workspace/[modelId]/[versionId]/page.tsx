...
export default function WorkspaceDetail({ params }: PageProps) {
  ...
  // null이나 undefined일 경우 early return
  if (params.versionId === null || params.versionId === undefined) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center">
        <div className="text-center">
          ...
          <p className="mb-8 text-gray-600">
            버전 정보가 필요합니다. 워크스페이스 목록으로 돌아가주세요.
          </p>
          <button
  ...
  // modelData가 있지만 버전이 없는 경우의 처리
  if (modelData && modelData.modelVersions.length === 0) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center">
        <div className="text-center">
          <h1 className="mb-4 text-2xl font-bold text-gray-900">
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="text-center">
          ...
          <div className="space-x-4">
            ...
            {modelData.modelVersions.length > 0 && (
              <button
                onClick={() =>
                  router.push(
